...
import styles from './CapsHats.module.scss'
...
function CapsHats({ data }) {
    const title = 'Caps & Hats'

    const product1 = data.filter((product) => product.name.includes('Cap'))
    const product2 = data.filter((product) => product.name.includes('Hat'))
