...
import styles from './OtherAccessories.module.scss'
...
function OtherAccessories({ data }) {
    const title = 'Other Accessories'

    const prevProducts = data.filter((product) => product.tag.includes('accessories'))
