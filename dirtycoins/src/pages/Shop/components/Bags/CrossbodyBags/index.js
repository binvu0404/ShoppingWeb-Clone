...
import styles from './CrossbodyBags.module.scss'
...
function CrossbodyBags({ data }) {
    const title = 'Crossbody Bags'

    const prevProducts = data.filter((product) => product.name.includes('CrossbodyBags'))
