...
import styles from './BowlerBags.module.scss'
...
function BowlerBags({ data }) {
    const title = 'Bowler Bags'

    const prevProducts = data.filter((product) => product.name.includes('Bowler Bags'))
