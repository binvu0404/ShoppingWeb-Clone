...
import styles from './DressesSkirts.module.scss'
...
function DressesSkirts({ data }) {
    const title = 'Dresses & Skirts'

    const product1 = data.filter((product) => product.name.includes('Dress'))
    const product2 = data.filter((product) => product.name.includes('Skirt'))

    const prevProducts = [...product1, ...product2]
