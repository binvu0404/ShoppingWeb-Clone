...
function Hoodies({ data }) {
    const title = 'Sweatshirts & Hoodies'

    const product1 = data.filter((product) => product.name.includes('Hoodie'))
    const product2 = data.filter((product) => product.name.includes('Sweatshirt'))
