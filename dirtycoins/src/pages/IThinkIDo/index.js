...
import styles from './IThinkIDo.module.scss'
...
function IThinkIDo({ data }) {
    const title = 'I Think I Do'

    const prevProducts = data.filter((product) => product.name.includes('I Think I Do'))
